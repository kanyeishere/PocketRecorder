...
#      NAME: Turing Ampere Ada Hopper Blackwell
#      NUM: Any number. Only those pairs are currently accepted by NVCC though:
#            7.5 8.0 8.6 8.7 8.9 9.0 10.0
#      Returns LIST of flags to be added to CUDA_NVCC_FLAGS in ${out_variable}
#      Additionally, sets ${out_variable}_readable to the resulting numeric list
#      Example:
#       CUDA_SELECT_NVCC_ARCH_FLAGS(ARCH_FLAGS 7.5 8.0+PTX Turing Ampere)
...
# The initial status here is for CUDA 10.0+ (Turing minimum)
set(CUDA_KNOWN_GPU_ARCHITECTURES  "Turing")
set(CUDA_COMMON_GPU_ARCHITECTURES "7.5" "8.0")
set(CUDA_LIMIT_GPU_ARCHITECTURE "10.0")
set(CUDA_ALL_GPU_ARCHITECTURES "7.5" "8.0" "8.6" "8.7" "8.9" "9.0" "10.0")
...
if(CUDA_VERSION VERSION_GREATER_EQUAL "11.1")
  ...
  set(CUDA_LIMIT_GPU_ARCHITECTURE "8.7")
endif()
