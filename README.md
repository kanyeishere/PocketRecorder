...
GitHub Actions 会先构建 `NativeRecorder.abi13.dll`，再打包插件，并校验发布 zip 中包含 native DLL 和 `avformat/avcodec/avutil/swresample` 运行时 DLL。
